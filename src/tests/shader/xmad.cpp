...
TEST_CASE("XMAD UE4", "[shader]") {
    REQUIRE(FuzzRun("XMAD.PSL.CBCC R2, R2.H1, R3.H1, R4;", 0x58238134) == 0xf196064a);
    REQUIRE(FuzzRun("XMAD R2, R2, c[2][0], R3;", 0x58238134) == 0xb5c8d183);
