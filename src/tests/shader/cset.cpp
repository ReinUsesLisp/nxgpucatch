...
TEST_CASE("CSET Variants", "[shader]") {
    REQUIRE(Run("CSET.BF.T.AND R0, CC, PT;") == 0x3f80'0000);
    REQUIRE(Run("CSET.BF.F.OR R0, CC, PT;") == 0x3f80'0000);
    REQUIRE(Run("CSET.BF.F.XOR R0, CC, PT;") == 0x3f80'0000);
    REQUIRE(Run("CSET.BF.T.AND R0, CC, !PT;") == 0x0000'0000);
}
