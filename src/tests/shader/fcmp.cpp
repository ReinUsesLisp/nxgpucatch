...
TEST_CASE("FCMP Simple", "[shader]") {
    ...
    REQUIRE(Run(1.0f, "FCMP.T.FTZ R2, R3, RZ, R2;") == -2);

    REQUIRE(Run(-1.0f, "FCMP.LT.FTZ R2, R3, RZ, c[2][0];") == -2);
    REQUIRE(Run(1.0f, "FCMP.LT.FTZ R2, R3, c[2][0], R2;") == 0x3f800000);

    REQUIRE(Run(1.0f, "FCMP.LT.FTZ R2, R3, 1, R2;") == 0x3f800000);

    REQUIRE(Run(-1.0f, "FCMP.LT.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(0.0f, "FCMP.EQ.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(1.0f, "FCMP.NE.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(-1.0f, "FCMP.LE.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(1.0f, "FCMP.GT.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(0.0f, "FCMP.GE.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(0.0f, "FCMP.GE.FTZ R2, R3, RZ, R2;") == -2);
}
...
TEST_CASE("FCMP NAN", "[shader]") {
    ...
    REQUIRE(Run(1.0f, "FCMP.NUM.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(nan, "FCMP.NUM.FTZ R2, R3, RZ, R2;") == 0);

    REQUIRE(Run(nan, "FCMP.F.FTZ R2, R3, RZ, R2;") == 0);
    REQUIRE(Run(nan, "FCMP.T.FTZ R2, R3, RZ, R2;") == -2);
    ...
    REQUIRE(Run(nan, "FCMP.NAN.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(nan, "FCMP.LTU.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(nan, "FCMP.EQU.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(nan, "FCMP.LEU.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(nan, "FCMP.GTU.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(nan, "FCMP.NEU.FTZ R2, R3, RZ, R2;") == -2);
    REQUIRE(Run(nan, "FCMP.GEU.FTZ R2, R3, RZ, R2;") == -2);
}

TEST_CASE("FCMP Denorm", "[shader][fpcontrol]") {
    static constexpr float denorm{1e-40};
    REQUIRE(Run(denorm, "FCMP.GT.FTZ R2, R3, RZ, R2;") == 0);
    REQUIRE(Run(denorm, "FCMP.GT R2, R3, RZ, R2;") == -2);
}
